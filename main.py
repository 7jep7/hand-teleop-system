...
def development_mode():
    ...
    print("🎯 Main Demo: http://localhost:3000/main_demo.html")
    print("🐛 Debug Tool: http://localhost:3000/debug_websocket.html")
    print("🤖 SO101 Demo: http://localhost:3000/test_so101_demo.html")
    print("=" * 60)
